...
- Wi-Fi and Bluetooth LE Firmware version 18.99.8.p3
- Driver version: MM6X18542.p8-GPL
...
**Note:** Download Labtool application for RF test mode [IW610 manufacturing firmware release](references.md).
