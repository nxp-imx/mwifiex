 ...
 *
 *
 * Copyright 2015-2022, 2024-2026 NXP
 *
...
/**
 * @brief send plinkstats event to vendorhal
 *
 * @param priv       A pointer to moal_private
 *
 * @return      N/A
...
{
	PRINTM(MEVENT, "wlan: Notify print plinkstats event\n");
	woal_cfg80211_vendor_event(priv, event_plinkstats,
				   CUS_EVT_PRINT_LINK_STATS,
						     ...
						     int data_len)
{
	...
	supp_feature_set = WLAN_FEATURE_INFRA
			   ...
			   WLAN_FEATURE_MKEEP_ALIVE | WLAN_FEATURE_TDLS;
	...
	/* Disable fw_roaming for Android
	#ifdef WIFI_HAL_ROAM
	#ifdef FW_ROAMING
