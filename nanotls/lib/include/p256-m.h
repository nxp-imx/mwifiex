...
/*
 * Zeroize function - function to zerioze memory.
 *
 * in: buf - buffer to be zeroize.
 *     bytes - number of bytes to zeroize.
 * out: buffer is filled with zeroes.
 */
extern void p256_mem_zeroize(void *buf, size_t bytes);
