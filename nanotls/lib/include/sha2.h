 ...
 * a full block.
 */
extern void cf_sha256_update(cf_sha256_context *ctx, const void *data,
			     size_t nbytes);
 ...
 */
extern void cf_sha256_digest(const cf_sha256_context *ctx,
 ...
 */
extern void cf_sha256_digest_final(cf_sha256_context *ctx,
				   uint8_t hash[CF_SHA256_HASHSZ]);
 ...
 * a full block.
 */
extern void cf_sha224_update(cf_sha256_context *ctx, const void *data,
			     size_t nbytes);
 ...
 * This leaves `ctx` unchanged.
 */
extern void cf_sha224_digest(const cf_sha256_context *ctx,
			     uint8_t hash[CF_SHA224_HASHSZ]);
 ...
 */
extern void cf_sha224_digest_final(cf_sha256_context *ctx,
				   uint8_t hash[CF_SHA224_HASHSZ]);
 ...
 * a full block.
 */
extern void cf_sha512_update(cf_sha512_context *ctx, const void *data,
			     size_t nbytes);
 ...
 * This leaves `ctx` unchanged.
 */
extern void cf_sha512_digest(const cf_sha512_context *ctx,
 ...
 */
extern void cf_sha512_digest_final(cf_sha512_context *ctx,
				   uint8_t hash[CF_SHA512_HASHSZ]);
 ...
 * a full block.
 */
extern void cf_sha384_update(cf_sha512_context *ctx, const void *data,
			     size_t nbytes);
 ...
 * This leaves `ctx` unchanged.
 */
extern void cf_sha384_digest(const cf_sha512_context *ctx,
			     uint8_t hash[CF_SHA384_HASHSZ]);
 ...
 */
extern void cf_sha384_digest_final(cf_sha512_context *ctx,
				   uint8_t hash[CF_SHA384_HASHSZ]);
