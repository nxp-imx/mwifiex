...
ENUM_ELEMENT(HostCmd_CMD_GET_HW_SPEC, 0x0003),
	...
	ENUM_ELEMENT(HostCmd_CMD_OFFLOAD_FEATURE_CONTROL, 0x00fd),
	/** Host Command ID : 802.11 K Get  Neighbor AP list*/
	ENUM_ELEMENT(HostCmd_CMD_802_11K_GET_NLIST, 0x0231),
	...
	ENUM_ELEMENT(HostCmd_CMD_RX_PKT_COALESCE_CFG, 0x012c),
#endif
	...
	ENUM_ELEMENT(HostCmd_CMD_HOST_CLOCK_CFG, 0x0246),
	...
	ENUM_ELEMENT(HostCmd_CMD_DOT11S_BEACON_CFG, 0x00cb),
#endif
	ENUM_ELEMENT(HostCmd_CMD_DOT11S_STA_STATE, 0x0253),
#endif
